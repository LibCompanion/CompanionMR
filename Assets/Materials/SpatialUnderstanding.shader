...
Shader "CompanionMR/SpatialUnderstanding" {
        ...
        Pass {
            ...
            CGPROGRAM
                ...
                void geom(triangle v2g i[3], inout TriangleStream<g2f> triStream) {
                    ...
                    // Output each original vertex with its distance to the opposing line defined by the other two vertices.
                    g2f o;
                    ...
                    for (uint idx = 0; idx < 3; ++idx) {
                        ...
                        //#Companion: Remove the diagonal line to get clear rectangular tiles
                        if (idx == 0) {
                            o.dist = distScale[idx] * o.viewPos.w * wireScale;
                        } else {
                            o.dist = distScale[idx] * o.viewPos.w * wireScale * 2000;
                        }
                        //#Companion
                ...
                float4 frag(g2f i) : COLOR {
                    // Calculate  minimum distance to one of the triangle lines, making sure to correct for perspective-correct interpolation.
                    float dist = min(i.dist[0], min(i.dist[1], i.dist[2])) * i.inverseW;

                    // Make the intensity of the line very bright along the triangle edges but fall-off very quickly.
                    ...
                    // Fade out the alpha but not the color so we don't get any weird halo effects from a fade to a different color.
